...
for type2 in regular fifo $(supported mknod && echo "block char") socket symlink; do
	...
	for type3 in none regular fifo $(supported mknod && echo "block char") socket symlink; do
